...
public class FanteCanAdapter extends Adapter<FanteCanAdapter.MyViewHolder>  {
    ...
    public class MyViewHolder extends ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Intent i = new Intent(FanteCanAdapter.this.context, DetailCanticleActivity.class);
            String str = "id";
            i.putExtra(str, (String) ((HashMap) FanteCanAdapter.this.canticleData.get(getAdapterPosition())).get(str));
            String str2 = "hymn_lyrics";
            i.putExtra(str2, (String) ((HashMap) FanteCanAdapter.this.canticleData.get(getAdapterPosition())).get(str2));
            String str3 = "hymn_title";
            i.putExtra(str3, (String) ((HashMap) FanteCanAdapter.this.canticleData.get(getAdapterPosition())).get(str3));
            FanteCanAdapter.this.context.startActivity(i);
        }

    }

    public FanteCanAdapter(Context context2, List<HashMap<String, String>> canticleData2) {
        this.context = context2;
        this.canticleData = canticleData2;
    }

    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fante_can, parent, false));
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.cardv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(FanteCanAdapter.this.context, DetailCanticleActivity.class);
                String str = "id";
                i.putExtra(str, (String) ((HashMap) FanteCanAdapter.this.canticleData.get(position)).get(str));
                String str2 = "hymn_lyrics";
                i.putExtra(str2, (String) ((HashMap) FanteCanAdapter.this.canticleData.get(position)).get(str2));
                String str3 = "hymn_title";
                i.putExtra(str3, (String) ((HashMap) FanteCanAdapter.this.canticleData.get(position)).get(str3));
                FanteCanAdapter.this.context.startActivity(i);
            }
        });
    }
